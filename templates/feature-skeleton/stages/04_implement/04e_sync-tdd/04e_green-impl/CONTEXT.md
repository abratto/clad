...
- Red test files are unchanged since the red receipt (`verify_test_continuity.py` runs at this stage and fails when a listed test file drifted; route any needed change through 04e-red as an R17 re-entry — never edit red tests from the green stage).
