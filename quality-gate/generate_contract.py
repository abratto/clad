...
def render_spec(concept: ap.ConceptSpec, outcomes: Dict[Tuple[str, str], Set[str]]) -> str:
    lines: List[str] = []
    lines.append("<!-- proposal snapshot — generated by generate_contract.py; "
                 "review, then fill TODOs; canonical contract: "
                 f"features/_system/concepts/{concept.name}.contract.md -->")
