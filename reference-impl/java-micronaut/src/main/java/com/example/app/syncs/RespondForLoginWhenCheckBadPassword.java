 ...
 *
 * <p>The declarative SyncRule realization of the Stage 03 RespondForLoginWhenCheckBadPassword.sync.md (grammar v2 name: RespondForLoginWhenCheckBadPassword; see maintenance/sync-dsl-legibility.md).
 ...
 */
public final class RespondForLoginWhenCheckBadPassword {

    public SyncRule rule() {
        return SyncRule.of(
                // renamed to grammar v2: "RespondForLoginWhenCheckBadPassword" -> "RespondForLoginWhenCheckBadPassword"
                "RespondForLoginWhenCheckBadPassword",
