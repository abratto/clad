 ...
 *
 * <p>The declarative SyncRule realization of the Stage 03 RespondForLoginWhenGrantGranted.sync.md (grammar v2 name: RespondForLoginWhenGrantGranted; see maintenance/sync-dsl-legibility.md).
 ...
 */
public final class RespondForLoginWhenGrantGranted {

    public SyncRule rule() {
        return SyncRule.of(
                // renamed to grammar v2: "RespondForLoginWhenGrantGranted" -> "RespondForLoginWhenGrantGranted"
