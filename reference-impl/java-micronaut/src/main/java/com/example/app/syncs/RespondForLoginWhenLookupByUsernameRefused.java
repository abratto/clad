 ...
 *
 * <p>The declarative SyncRule realization of the Stage 03 RespondForLoginWhenLookupByUsernameRefused.sync.md (grammar v2 name: RespondForLoginWhenLookupByUsernameRefused; see maintenance/sync-dsl-legibility.md).
 ...
 */
public final class RespondForLoginWhenLookupByUsernameRefused {

    public SyncRule rule() {
        return SyncRule.of(
                // renamed to grammar v2: "RespondForLoginWhenLookupByUsernameRefused" -> "RespondForLoginWhenLookupByUsernameRefused"
                "RespondForLoginWhenLookupByUsernameRefused",
