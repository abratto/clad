 ...
 *
 * <p>The declarative SyncRule realization of the Stage 03 RespondWhenCheckBadPassword.sync.md (grammar v2 name: RespondWhenCheckBadPassword; see maintenance/sync-dsl-legibility.md).
 ...
 */
public final class RespondWhenCheckBadPassword {

    public SyncRule rule() {
        return SyncRule.of(
                // renamed to grammar v2: "RespondWhenCheckBadPassword" -> "RespondWhenCheckBadPassword"
