...
- Worked example: [`examples/UC-00-login/README.md`](examples/UC-00-login/README.md)
- New-feature bootstrap: [`templates/feature-skeleton/`](templates/feature-skeleton/) (copy this, do **not** copy `examples/UC-00-login/`)
