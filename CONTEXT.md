...
| See a worked example end-to-end | [`features/UC-00-login/README.md`](features/UC-00-login/README.md) (start at `stages/01_usecase/`; its Stage 00 outputs live in `features/_system/stages/00_actor-goal/`) |
