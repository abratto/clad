...
| Reuse or propose a concept | [`features/_system/concepts-catalog.md`](features/_system/concepts-catalog.md) (generated index) and [`features/_system/concept-dependence.md`](features/_system/concept-dependence.md); concepts live in [`features/_system/concepts/`](features/_system/concepts/); promote approved proposals with `./clad promote-concepts` |
