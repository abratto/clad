...
|---|---|---|---|---|
| `lookupByUsername` | `LookupByUsernameForLoginWhenRequestRouted` (`successful-login`, `wrong-password`, `unknown-user`, `lockout`) | `username` | A | `Web/request` trigger `?u` |
...
- The sync `LookupByUsernameForLoginWhenRequestRouted` exists under `../../03_syncs/output/`.
