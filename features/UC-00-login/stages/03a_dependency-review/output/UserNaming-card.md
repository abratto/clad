...
|---|---|---|---|---|
| `lookupByUsername` | `LookupByUsernameWhenRequestRouted` (`successful-login`, `wrong-password`, `unknown-user`, `lockout`) | `username` | A | `Web/request` trigger `?u` |
...
- The sync `LookupByUsernameWhenRequestRouted` exists under `../../03_syncs/output/`.
