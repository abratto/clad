...
|---|---|---|---|---|
| `lookupByUsername` | `UserNamingLookupByUsernameForLoginWhenWebRequestRouted` (`successful-login`, `wrong-password`, `unknown-user`, `lockout`) | `username` | A | `Web/request` trigger `?u` |
...
- The sync `UserNamingLookupByUsernameForLoginWhenWebRequestRouted` exists under `../../03_syncs/output/`.
