...
| User | `lookupByUsername` | `NOT_FOUND` | `lookupByUsername_returns_NOT_FOUND_for_unregistered_username` | stub |
...
| PasswordAuth | `check` | `LOCKED` | `check_returns_LOCKED_for_locked_account` | stub |
