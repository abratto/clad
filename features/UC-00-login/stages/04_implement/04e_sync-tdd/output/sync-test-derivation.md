...
|---|---|---|---|---|
| LookupByUsernameWhenRequestRouted | `Web.request { outcome: ROUTED }` | `UserNaming.lookupByUsername(username)` | `routed_login_invokes_user_lookup` | green — flow coverage |
