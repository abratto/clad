...
| 02b | [`stages/02b_chain-table/CONTEXT.md`](stages/02b_chain-table/CONTEXT.md) | [`successful-login-chain.md`](stages/02b_chain-table/output/successful-login-chain.md), [`wrong-password-chain.md`](stages/02b_chain-table/output/wrong-password-chain.md), [`unknown-user-chain.md`](stages/02b_chain-table/output/unknown-user-chain.md), [`lockout-chain.md`](stages/02b_chain-table/output/lockout-chain.md) | Four scenarios, four chain tables. These are the **canonical action names** — `User.lookupByUsername`, `PasswordAuth.check`, `Session.grant` — that PR #6 reconciled the syncs back to. |
