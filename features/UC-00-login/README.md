...
| 03 | [`stages/03_syncs/CONTEXT.md`](stages/03_syncs/CONTEXT.md) | [`UserNamingLookupByUsernameForLoginWhenWebRequestRouted.sync.md`](stages/03_syncs/output/UserNamingLookupByUsernameForLoginWhenWebRequestRouted.sync.md), [`PasswordAuthCheckForLoginWhenUserNamingLookupByUsernameFound.sync.md`](stages/03_syncs/output/PasswordAuthCheckForLoginWhenUserNamingLookupByUsernameFound.sync.md), [`WebRespondForLoginWhenUserNamingLookupByUsernameRefused.sync.md`](stages/03_syncs/output/WebRespondForLoginWhenUserNamingLookupByUsernameRefused.sync.md), [`SessionGrantForLoginWhenPasswordAuthCheckOk.sync.md`](stages/03_syncs/output/SessionGrantForLoginWhenPasswordAuthCheckOk.sync.md), [`WebRespondForLoginWhenPasswordAuthCheckBadPassword.sync.md`](stages/03_syncs/output/WebRespondForLoginWhenPasswordAuthCheckBadPassword.sync.md), [`WebRespondForLoginWhenPasswordAuthCheckLocked.sync.md`](stages/03_syncs/output/WebRespondForLoginWhenPasswordAuthCheckLocked.sync.md), [`WebRespondForLoginWhenSessionGrantGranted.sync.md`](stages/03_syncs/output/WebRespondForLoginWhenSessionGrantGranted.sync.md) | UC-00 now shows the canonical one-sync-per-transition shape. `WebRespondForLoginWhenSessionGrantGranted` is the worked example's Pattern B join; the 401 branches are syncs too, so Stage 03 remains the single declarative coordination surface. |
...
- [`../../methodology/architecture/SYNC_PATTERNS.md`](../../methodology/architecture/SYNC_PATTERNS.md) — the four legal `where` patterns; needed for `WebRespondForLoginWhenSessionGrantGranted`'s Pattern B `where:` clause and for reading the 03a cards.
