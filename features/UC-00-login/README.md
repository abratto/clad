...
| 03 | [`stages/03_syncs/CONTEXT.md`](stages/03_syncs/CONTEXT.md) | [`LookupByUsernameForLoginWhenRequestRouted.sync.md`](stages/03_syncs/output/LookupByUsernameForLoginWhenRequestRouted.sync.md), [`CheckWhenLookupByUsernameFound.sync.md`](stages/03_syncs/output/CheckWhenLookupByUsernameFound.sync.md), [`RespondWhenLookupByUsernameRefused.sync.md`](stages/03_syncs/output/RespondWhenLookupByUsernameRefused.sync.md), [`GrantWhenCheckOk.sync.md`](stages/03_syncs/output/GrantWhenCheckOk.sync.md), [`RespondWhenCheckBadPassword.sync.md`](stages/03_syncs/output/RespondWhenCheckBadPassword.sync.md), [`RespondWhenCheckLocked.sync.md`](stages/03_syncs/output/RespondWhenCheckLocked.sync.md), [`RespondWhenGrantGranted.sync.md`](stages/03_syncs/output/RespondWhenGrantGranted.sync.md) | UC-00 now shows the canonical one-sync-per-transition shape. `RespondWhenGrantGranted` is the worked example's Pattern B join; the 401 branches are syncs too, so Stage 03 remains the single declarative coordination surface. |
...
- [`../../methodology/architecture/SYNC_PATTERNS.md`](../../methodology/architecture/SYNC_PATTERNS.md) — the four legal `where` patterns; needed for `RespondWhenGrantGranted`'s Pattern B `where:` clause and for reading the 03a cards.
