...
| 04b | [`stages/04_implement/04b_contract/CONTEXT.md`](stages/04_implement/04b_contract/CONTEXT.md) | [`UserNaming.spec.md`](stages/04_implement/04b_contract/output/UserNaming.spec.md), [`PasswordAuth.spec.md`](stages/04_implement/04b_contract/output/PasswordAuth.spec.md), [`Session.spec.md`](stages/04_implement/04b_contract/output/Session.spec.md) | Mechanically-extracted Contract slices the test code compiles against. |
