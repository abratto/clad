...
| 04d-red | [`stages/04_implement/04d_concept-tdd/04d_red-tests/CONTEXT.md`](stages/04_implement/04d_concept-tdd/04d_red-tests/CONTEXT.md) | [`concept-test-derivation.md`](stages/04_implement/04d_concept-tdd/04d_red-tests/output/concept-test-derivation.md) + per-concept test files | Derive and approve red concept tests from `04c` + `04b`; no implementation code. |
...
| 04e-red | [`stages/04_implement/04e_sync-tdd/04e_red-tests/CONTEXT.md`](stages/04_implement/04e_sync-tdd/04e_red-tests/CONTEXT.md) | [`sync-test-derivation.md`](stages/04_implement/04e_sync-tdd/04e_red-tests/output/sync-test-derivation.md) + per-sync test files | Derive and approve red sync tests from Stage 03 + `04c`; no implementation code. |
